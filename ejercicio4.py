import langchain
# para mirar el paso a paso de la ejecución de la cadena
...
# Unimos las cadenas pasando la salida de la primera al argumento de la segunda
cadena_compuesta = (
    {"respuesta_analisis_imagen": cadena_analisis} 
    | cadena_resumen
)
